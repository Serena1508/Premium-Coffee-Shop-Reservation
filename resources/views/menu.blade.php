            ...
            <div class="row">
                <div class="col-md-4 hover-up" style="margin-bottom: 10px;">
                    <div class="single-menu-item">
                        ...
                        <img src="\assets\images\cofeee.jpg" class="coffe-img-container" alt="...">
                        </div>
                ...
                <div class="col-md-4 hover-up" style="margin-bottom: 10px;">
                    <div class="single-menu-item">
                        <div class="coffe-img-container">
                        <img src="\assets\images\ice blended.jpg" class="coffe-img-container" alt="...">
                        </div>
                        <div class="coffe-description">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 hover-up" style="margin-bottom: 10px;">
                    <div class="single-menu-item">
                        <div class="coffe-img-container">
                        <img src="\assets\images\Cheesecake.jpg" class="coffe-img-container" alt="...">
                        </div>
                        <div class="coffe-description">
                ...
                <div class="col-md-4 hover-up" style="margin-bottom: 10px;">
                    <div class="single-menu-item">
                        <div class="coffe-img-container">
                        <img src="\assets\images\appleturnover.jpg" class="coffe-img-container" alt="...">
                        </div>
                        <div class="coffe-description">
                ...
                <div class="col-md-4 hover-up" style="margin-bottom: 10px;">
                    <div class="single-menu-item">
                        <div class="coffe-img-container">
                        <img src="\assets\images\chocolate.webp" class="coffe-img-container" alt="...">
                        </div>
                        <div class="coffe-description">
